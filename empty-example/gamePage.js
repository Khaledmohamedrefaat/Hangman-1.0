...
function gamePage(){
  ...
  this.initialize = function(){
    ...
    hints_lbl = new label(1230,150,'#52425d',35,jelle_roman,'test');
    ...
    hints_btn = new button(1362, 679, 146, 42, 21, 1, '#ff6a63', 1400, 710, '#FFFCED', 30.37, folks_bold, 'HINT');
  }
  this.show = function(){
    if (this.isVisible){
      hints_lbl.text = 'Hints : '+hints_count;
      checkLives();
